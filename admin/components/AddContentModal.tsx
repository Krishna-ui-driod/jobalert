            ...
            {isExamFlow && (
              <>
                ...
                <Field label="Description">
                  <textarea className={`${INPUT_CLS} min-h-24 resize-y`} value={examForm.description} onChange={e => setExamField('description', e.target.value)} placeholder="Brief description of the exam…" />
                </Field>
